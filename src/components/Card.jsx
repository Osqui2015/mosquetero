  ...
  return posts.map((post) => (
    <div key={post._id}>
      <div className="card mb-3">
        ...
        <div className="card-body">{post.show}</div>
        <div className="card-footer text-muted">
          ...
          <button type="button" className="btn mx-2 btn-outline-warning">
            {" "}
            <i className="bi bi-heart"></i>{" "}
          </button>

          <button type="button" className="btn mx-2 mt-2 btn-outline-info">
            {" "}
